...
rm -rf /app/* &>>$log_file
validate $? "Removing the existing shipping code in app directory"

unzip /tmp/shipping.zip &>>$log_file
validate $? "unzipping the shipping code in app directory location"
...
validate $? "copying shipping.service file and setting up systemd service"
...
validate $? "installing the mysql client to connect with mysql db"
